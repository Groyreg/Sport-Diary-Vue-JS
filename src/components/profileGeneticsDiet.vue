  ...
  <div class="genetics-diet">
    <div class="row">
      ...
      <div class="prof-genetics-diet-data col-xs-12 col-sm-8 col-md-9 col-lg-9">
        ...
        <div>
          <button v-if="editTable" class=" btn-gt btn btn-primary" @click="save()">save</button>
          <button v-if="editTable" class=" btn-gt btn btn-primary" @click="resetForm()">cancel</button>
          <button v-if="!editTable" class=" btn-gt btn btn-primary" @click="editTable=true">edit</button>
        </div>
        <div class="prof-genetics-data">
            ...
            <div v-for="gene in filteredGenes" class="tbl-row row">
              ...
              <div class="snp-var-data-container col-xs-9 col-md-9">
                <div v-for="snp in gene.snps" class="snp-var-data-content row">
                  ...
                  <button class="gtd-var-btn-clear gtm-var-btn-clear close col-md-3" type="button" aria-hidden="true">×
                  </button>
                </div>
              </div>
            </div>
          ...
          <!-- <p class="pgd-text col-xs-12">
            Основой всех диет является баланс трёх основных веществ: углеводов, белков и
            жиров. Какой бы не была выбранная вами диета, все три компонента необходимы
            вашему организму.
          </p> -->
        </div>
